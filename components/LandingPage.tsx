            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto animate-in fade-in slide-in-from-bottom-8 delay-300">
                    ...
                    <div 
                        ...
                        className="group bg-slate-900/50 backdrop-blur border border-slate-800 hover:border-emerald-500/50 p-8 rounded-2xl cursor-pointer text-left transition-all hover:bg-slate-900"
                    >
                    ...
                    <div 
                        ...
                        className="group bg-slate-900/50 backdrop-blur border border-slate-800 hover:border-indigo-500/50 p-8 rounded-2xl cursor-pointer text-left transition-all hover:bg-slate-900"
                    >
                        ...
                        <div className="flex items-center text-indigo-400 font-bold text-sm group-hover:gap-2 transition-all">
                            Seller Console <ArrowRight className="w-4 h-4 ml-1" />
                        </div>
                    </div>
